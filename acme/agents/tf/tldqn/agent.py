...
class TFDQN(agent.Agent):
  ...
  https://dl.acm.org/doi/10.5555/3306127.3331714
  """
  ...
  def __init__(
    ...
    Args:
      ...
      networks: the online Q networks for each objective
    ...
    target_networks = [copy.deepcopy(network) for network in networks]
